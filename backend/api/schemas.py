...
class ScanResponse(BaseModel):
    """Response schema for secret scanner"""
    secrets_found: bool = Field(..., description="Whether secrets were detected")
    matches: List[SecretMatch] = Field(default_factory=list, description="Detected secrets")
